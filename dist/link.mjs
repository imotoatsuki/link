...
(function(k) {
  var w = function() {
    ...
    return h && (o[Symbol.iterator] = function() {
      return o;
    }), o;
  }, c = function(n) {
    ...
    }, h && (o[Symbol.iterator] = o.entries), o.toString = function() {
      var e = [];
      return this.forEach(function(s, d) {
        e.push(c(d) + "=" + c(s));
      }), e.join("&");
  ...
  typeof l.sort != "function" && (l.sort = function() {
    var n = this, o = [];
    this.forEach(function(s, d) {
      o.push([d, s]), n._entries || n.delete(d);
    }), o.sort(function(s, d) {
      return s[0] < d[0] ? -1 : s[0] > d[0] ? 1 : 0;
    ...
    value: function(n) {
      ...
      n = n.replace(/^\?/, "");
      for (var s = n.split("&"), d, e = 0; e < s.length; e++)
        d = s[e].split("="), this.append(
          i(d[0]),
          d.length > 1 ? i(d[1]) : ""
        );
    }
...
(function(k) {
  var w = function() {
    ...
    var c = k.URL, i = function(l, n) {
      ...
      var d = o.createElement("input");
      if (d.type = "url", d.value = l, s.protocol === ":" || !/:/.test(s.href) || !d.checkValidity() && !n)
  ...
  if (w() || h(), k.location !== void 0 && !("origin" in k.location)) {
    var v = function() {
  ...
  (function(h, v) {
    ...
    return function(h) {
      ...
      function c(i) {
        ...
        return h[i].call(a.exports, a, a.exports, c), a.l = !0, a.exports;
      }
      return c.m = h, c.c = v, c.d = function(i, a, p) {
      ...
      c(4);
      var a, p, l, n, o, e, s = c(8), d = (p = function(t) {
        ...
        switch (t.method) {
          ...
          case "UPDATE":
            ...
            (s.isFormData(t.data) || s.isFormElement(t.data)) && (r = a.FORM), t.data = e(t.data, r), r !== d.contentType.FORM && (t.headers["content-type"] = r);
        }
        return t;
      }, e = function() {
        var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      ...
      (function(i, a) {
        (function(p, l) {
          if (!p.setImmediate) {
            var n, o, e, s, d, t = 1, y = {}, r = !1, u = p.document, f = Object.getPrototypeOf && Object.getPrototypeOf(p);
            ...
            }() ? (s = "setImmediate$" + Math.random() + "$", d = function(g) {
      ...
      var o, e = [], s = !1, d = -1;
      function t() {
        s && o && (s = !1, o.length ? e = o.concat(e) : d = -1, e.length && y());
      }
      function y() {
        if (!s) {
          var f = n(t);
      ...
      var c = function(a) {
        ...
        return p = p || null, l = l || "&", n = n || null, a ? function(o) {
          ...
          var e, s, d = o;
          if (n && (d = n + "[" + d + "]"), typeof a[o] == "object" && a[o] !== null)
            e = i(a[o], null, l, d);
          else {
            p && (s = d, d = !isNaN(parseFloat(s)) && isFinite(s) ? p + Number(d) : d);
            var t = a[o];
            t = (t = (t = (t = t === !0 ? "1" : t) === !1 ? "0" : t) === 0 ? "0" : t) || "", e = c(d) + "=" + c(t);
          }
          return e;
        })).join(l).replace(/[!'()*]/g, "") : "";
      };
...
class I {
   ...
   */
  constructor({ data: w, config: h, api: v, readOnly: c }) {
    this.api = v, this.readOnly = c, this.config = {
      endpoint: h.endpoint || "",
      headers: h.headers || {},
      doFetch: h.doFetch || null
    }, this.nodes = {
      wrapper: null,
      container: null,
      progress: null,
  ...
  makeInputHolder() {
    ...
    }), this.nodes.input.dataset.placeholder = this.api.i18n.t("Link"), this.readOnly || (this.nodes.input.addEventListener("paste", (h) => {
      this.startFetching(h);
    }), this.nodes.input.addEventListener("keydown", (h) => {
      const [v, c] = [13, 65], i = h.ctrlKey || h.metaKey;
      switch (h.keyCode) {
        case v:
          h.preventDefault(), h.stopPropagation(), this.startFetching(h);
          break;
        case c:
          i && this.selectLinkUrl(h);
          break;
      }
  ...
  startFetching(w) {
    ...
    w.type === "paste" && (h = (w.clipboardData || window.clipboardData).getData("text")), this.removeErrorStyle(), this.fetchLinkData(h);
  }
  /**
   ...
   */
  showLinkPreview({ image: w, title: h, description: v }) {
    this.nodes.container.appendChild(this.nodes.linkContent), w && w.url && (this.nodes.linkImage.style.backgroundImage = "url(" + w.url + ")", this.nodes.linkContent.appendChild(this.nodes.linkImage)), h && (this.nodes.linkTitle.textContent = h, this.nodes.linkContent.appendChild(this.nodes.linkTitle)), v && (this.nodes.linkDescription.textContent = v, this.nodes.linkContent.appendChild(this.nodes.linkDescription)), this.nodes.linkContent.classList.add(this.CSS.linkContentRendered), this.nodes.linkContent.setAttribute("href", this.data.link), this.nodes.linkContent.appendChild(this.nodes.linkText);
    try {
  ...
  async fetchLinkData(w) {
    ...
    try {
      const { body: h } = this.config.doFetch ? await this.config.doFetch(
        {
          url: w,
  ...
  onFetch(w) {
    ...
    const h = w.meta, v = w.link || this.data.link;
    if (this.data = {
      meta: h,
      link: v
    }, !h) {
    ...
    this.hideProgress().then(() => {
      this.nodes.inputHolder.remove(), this.showLinkPreview(h);
    });
  }
  /**
  ...
  make(w, h = null, v = {}) {
    ...
    Array.isArray(h) ? c.classList.add(...h) : h && c.classList.add(h);
    for (const i in v)
      c[i] = v[i];
    return c;
  }
